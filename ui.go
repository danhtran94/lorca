...
// your UI code.
func New(url, dir string, width, height int, logger logger, customArgs ...string) (UI, error) {
	if url == "" {
	...
	chrome, err := newChromeWithArgs(ChromeExecutable(), logger, args...)
	chrome.logger = logger
